// Настройки подключения к твоему живому серверу на Render
// ЗАМЕНИ ССЫЛКУ НИЖЕ НА СВОЮ ИЗ RENDER (ОБЯЗАТЕЛЬНО С wss:// В НАЧАЛЕ)
const SERVER_URL = 'wss://твой-проект.onrender.com';
